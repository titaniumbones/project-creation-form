      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-3xl mx-auto px-4 py-8">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
            ...
            <h2 className="text-base font-semibold text-red-800 mb-2">Unable to Load Draft</h2>
      ...
      <main className="max-w-3xl mx-auto px-4 py-4">
        ...
        {!isAlreadyProcessed && (
          <div className="mt-8 p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
            <h3 className="text-base font-semibold text-gray-900 mb-4">Approval Decision</h3>
        ...
        {Object.keys(createdResources).length > 0 && (
          <div className="mt-8 p-4 bg-green-50 rounded-lg border border-green-200">
            <h3 className="text-base font-semibold text-green-800 mb-4">Created Resources</h3>
        ...
        {showNotesModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 p-4">
              <h3 className="text-base font-semibold text-gray-900 mb-4">Request Further Review</h3>
